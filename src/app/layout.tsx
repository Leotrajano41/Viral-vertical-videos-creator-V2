      ...
      <body className="min-h-screen flex bg-background text-gray-100 antialiased selection:bg-indigo-500 selection:text-white bg-grid-pattern">
        ...
        <aside className="w-64 bg-[#141427]/80 backdrop-blur-xl border-r border-white/10 flex flex-col justify-between p-5 relative z-20">
          <div>
            ...
            {/* Navigation Menu (Exactly 9 items - Original Desktop Order) */}
            <nav className="space-y-1">
              <Link
                href="/"
                className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all group"
              >
              ...
              <Link
                ...
                className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all group"
              >
                <Film size={18} className="text-cyan-400 group-hover:scale-110 transition" />
                Criar vídeos
              </Link>
              <Link
                href="/trends"
              ...
              <Link
                ...
                className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all group"
              >
                <Newspaper size={18} className="text-blue-400 group-hover:text-blue-300 transition" />
                Notícias
              </Link>
              <Link
                href="/render-queue"
              ...
              <Link
                ...
                className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all group"
              >
                <History size={18} className="text-rose-400 group-hover:text-rose-300 transition" />
                Histórico
              </Link>
              <Link
                href="/youtube"
                className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all group"
              >
                <Youtube size={18} className="text-red-500 group-hover:scale-110 transition" />
                YouTube
              </Link>
